...
{
    glColor3f(0, 0, 1);
    bitmap_output(150, 665,(char*)" SORTING ALGORITHM VISUALIZER", GLUT_BITMAP_TIMES_ROMAN_24);
...
// other text small font
    bitmap_output(10, 625, (char*)"This program sorts a random set of numbers in ascending order displaying them graphically as ", GLUT_BITMAP_9_BY_15);
    bitmap_output(10, 605, (char*)"bars with varying height", GLUT_BITMAP_9_BY_15);
    ...
    {
        bitmap_output(10, 575, (char*)"MENU", GLUT_BITMAP_9_BY_15);
        bitmap_output(10, 555, (char*)"Press s to SORT", GLUT_BITMAP_9_BY_15);
        bitmap_output(10, 535, (char*) "Press c to SELECT the sort algorithm", GLUT_BITMAP_9_BY_15);
        bitmap_output(10, 515, (char*)"Press r to RANDOMISE", GLUT_BITMAP_9_BY_15);
        bitmap_output(10, 495, (char*)"Esc to QUIT", GLUT_BITMAP_9_BY_15);
        bitmap_output(10, 475, (char*)"Selected sort: ", GLUT_BITMAP_9_BY_15);
        bitmap_output(150, 475, (char*)(sort_string + sort_count), GLUT_BITMAP_9_BY_15);
    }
...
void front()
{
    ...
    bitmap_output(300, 565, (char*)"WELCOME!", GLUT_BITMAP_TIMES_ROMAN_24);
    glBegin(GL_LINE_LOOP);
    glVertex2f(295, 560);
    glVertex2f(395, 560);
    glEnd();
    bitmap_output(330, 525, (char*)"TO", GLUT_BITMAP_TIMES_ROMAN_24);
    glBegin(GL_LINE_LOOP);
    glVertex2f(325, 521);
    glVertex2f(360, 521);
    glEnd();
    ...
    bitmap_output(150, 475, (char*) " SORTING ALGORITHM VISUALIZER", GLUT_BITMAP_TIMES_ROMAN_24);
    glBegin(GL_LINE_LOOP);
    glVertex2f(145, 470);
    glVertex2f(520, 470);
    glEnd();
